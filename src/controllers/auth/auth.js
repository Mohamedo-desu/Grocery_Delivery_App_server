...
import { CustomerModel, DeliveryPartnerModel } from "../../models/index.js";
...
export const loginDeliveryPartner = async (req, res) => {
  try {
    ...
    if (!deliveryPartner || password !== DeliveryPartnerModel.password) {
...
export const refreshToken = async (req, res) => {
  try {
    ...
    const user = await (role === ROLES.CUSTOMER
      ...
      : DeliveryPartnerModel.findById(userId));
